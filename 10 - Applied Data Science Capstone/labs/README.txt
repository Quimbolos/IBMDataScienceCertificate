...
7 - Interactive Analysis - Plotly Dash.py: Second assignment for Week 3, creating a web-based interactive dashboard using Dash and Plotly.
8 - Machine Learning - Classifier Predictions.ipynb: Note assignment for Week 4, building and evaluating Classification Machine Learning models to predict the landing outcome.
