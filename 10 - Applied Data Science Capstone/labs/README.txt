...
- 3 - Data Wrangling.ipynb: First assignment notebook for Week 2, exploring data with SQL queries.
- 4 - Exploratory Analysis - SQL.ipynb: Second assignment notebook for Week 2, Exploratory Data Analysis (EDA) to find some patterns in the data and determine what would be the label for training supervised models..
- 5 - Exploratory Analysis - Data Visz.ipynb: 
- 6 - Interactive Analysis - Folium.ipynb: First assignment notebook for Week 3, analyzing geospatial data.
